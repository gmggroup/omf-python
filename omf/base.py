...
class UidModel(properties.HasProperties):
    ...
    def serialize(self, include_class=True, registry=None,                     #pylint: diable=arguments-differ
    ...
    @classmethod
    def deserialize(cls, uid, trusted=True, registry=None, **kwargs):          #pylint: diable=arguments-differ
